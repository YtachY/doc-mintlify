---
title: "RSA Improved LITCTF Crypto Writeup: Multi-Prime Attack"
description: "LITCTF crypto writeup for RSA Improved: exploit a multi-prime RSA modulus with small 32-bit factors, factor n, recover phi, and decrypt the flag."
---
...
```python rsa_improved.py expandable lines
