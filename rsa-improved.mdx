---
title: "RSA Improved — LITCTF multi-prime RSA writeup"
description: "LITCTF RSA Improved writeup breaking a multi-prime RSA scheme by factoring the 640-bit modulus into small 32-bit primes to recover the flag."
---
